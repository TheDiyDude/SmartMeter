...
class orno:
  ...
  def print(self):
    if self.type == 0:
      ...
      print(f"L2 Active Energy            {self.L2_AEnergy:.3f}")
      print(f"L2 Forward Active Energy    {self.L2_FAEnergy:.3f}")
      print(f"L2 Reverse Active Energy    {self.L2_RAEnergy:.3f}")
      ...
      print(f"L3 Active Energy            {self.L3_AEnergy:.3f}")
      print(f"L3 Forward Active Energy    {self.L3_FAEnergy:.3f}")
      print(f"L3 Reverse Active Energy    {self.L3_RAEnergy:.3f}")
      print(f"Grid Frequency              {self.L1_frequency:.2f}")
